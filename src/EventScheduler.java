...
final class EventScheduler
{
    ...
    public EventScheduler(double timeScale)
   {
    ...
    public void scheduleActions(Entity entity, WorldModel world, EntityFactory entityFactory)
    {
        if (entity instanceof Active)
        {
            scheduleEvent(entity, new ActivityAction((Active) entity, world, entityFactory),
                    ((Active) entity).getActionPeriod());
        }
        if (entity instanceof Animate)
        {
            scheduleEvent(entity, new AnimationAction((Animate) entity,((Animate) entity).getRepeatCount()),
